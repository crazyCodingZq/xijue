package com.zq.xijue.core.security;

import com.zq.xijue.core.security.authentication.*;
import com.zq.xijue.core.security.validate.code.ValidateCodeSecurityConfig;
import com.zq.xijue.core.security.validate.mobile.SmsCodeAuthenticationSecurityConfig;
...
//        tokenRepository.setCreateTableOnStartup(true);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // 默认登陆Url
                .loginProcessingUrl(SecurityConstants.LOGIN_PROCESSING_URL_FORM).failureUrl("/login?error=true")
                // 设置登陆成功/失败处理逻辑
                ...
                .sessionManagement()
                .invalidSessionUrl(SecurityConstants.UN_AUTHENTICATION_URL)
                // 单用户最大session数
                .maximumSessions(1)
    ...
    public void configure(WebSecurity web) throws Exception {
        // 设置拦截忽略文件夹，可以对静态资源放行
        web.ignoring().antMatchers("/assets/**", "/css/**", "/images/**", "/js/**", "/templates/**");
    }
}
